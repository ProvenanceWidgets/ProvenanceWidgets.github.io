...
<Tabs groupId='framework'>
  <TabItem value='angular' label='Angular'>
    ```bash
    git clone --branch v1 https://github.com/ProvenanceWidgets/provenance-widgets-starter
    ```
  </TabItem>
  <TabItem value='web-components' label='Web Components'>
  ```bash
  git clone --branch v1 https://github.com/ProvenanceWidgets/provenance-widgets-vanilla-starter
  ```
  </TabItem>
</Tabs>
...
```bash
npm install provenance-widgets@^1.0.4
```
